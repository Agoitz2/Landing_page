			...
			<div className = 'hero-page'>
				<header className = 'header min-vh-100 position-relative'>
					...
					<div className = 'content position-absolute translate-middle top-50 start-50 text-center'>
						<h3 className = 'brand-name mb-5' ><span>B</span>uen<span>V</span>iaje</h3>
						...
						<a href = '#navbar' className = 'btn btn-outline-primary text-capitalize btn-sm'>click to scroll down <i className="fas fa-arrow-down ms-2"></i></a>
					</div>
				</header>
			</div>
		)
